...
type ILaTexFormattable =
    abstract member ToLaTexString: unit -> string
...
with
    ...
    interface ILaTexFormattable with
...
module Functions =
    type LaTeXFunction<'T when 'T :> ILaTexFormattable> =
    | LF1 of Expression<Func<'T, 'T>> * string*string
    | LF2 of Expression<Func<'T, 'T, 'T>> * string*string
    with
        static member inline GetLF1 name = Expression.Lambda<Func<'T, 'T>>(Expression.Call(null, typeof<'T>.GetMethod(name), Expression.Parameter(typeof<'T>, "x")), Expression.Parameter(typeof<'T>, "x"))
        static member inline GetLF2 name = Expression.Lambda<Func<'T, 'T, 'T>>(Expression.Call(null, typeof<'T>.GetMethod(name), Expression.Parameter(typeof<'T>, "x"), Expression.Parameter(typeof<'T>, "y")), Expression.Parameter(typeof<'T>, "x"), Expression.Parameter(typeof<'T>, "y"))

        static member inline sqrt = LaTeXFunction<'T>.GetLF1 "Sqrt", "sqrt", "\\sqrt"

        static member inline sin =  LaTeXFunction<'T>.GetLF1 "Sin", "sin", "\\sin"
        static member inline cos =  LaTeXFunction<'T>.GetLF1 "Cos", "cos", "\\cos"
        static member inline tan =  LaTeXFunction<'T>.GetLF1 "Tan", "tan", "\\tan"

        static member inline asin = LaTeXFunction<'T>.GetLF1 "Asin", "asin", "\\asin"
        static member inline acos = LaTeXFunction<'T>.GetLF1 "Acos", "acos", "\\acos"
        static member inline atan = LaTeXFunction<'T>.GetLF1 "Atan", "atan", "\\atan"

        static member inline sinh = LaTeXFunction<'T>.GetLF1 "Sinh", "sinh", "\\sinh"
        static member inline cosh = LaTeXFunction<'T>.GetLF1 "Cosh", "cosh", "\\cosh"
        static member inline tanh = LaTeXFunction<'T>.GetLF1 "Tanh", "tanh", "\\tanh"

        static member inline asinh = LaTeXFunction<'T>.GetLF1 "Asinh", "asinh", "\\asinh"
        static member inline acosh = LaTeXFunction<'T>.GetLF1 "Acosh", "acosh", "\\acosh"
        static member inline atanh = LaTeXFunction<'T>.GetLF1 "Atanh", "atanh", "\\atanh"

        static member inline exp = LaTeXFunction<'T>.GetLF1 "Exp", "exp", "\\exp"
        static member inline log = LaTeXFunction<'T>.GetLF1 "Log", "log", "\\ln"
        static member inline log10 = LaTeXFunction<'T>.GetLF1 "Log10", "log10", "\\log_{10}"
